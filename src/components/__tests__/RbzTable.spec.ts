...
describe('RbzTable.vue', () => {
  ...
  describe('filtering', () => {
    ...
    test('should filter normal table values by the filter input', async () => {
      ...
      const firstDataCell = wrapper.findAll('.vertical-align-middle').at(0)
      const secondDataCell = wrapper.findAll('.vertical-align-middle').at(1)
    ...
    test('should be able to filter null values', async () => {
      ...
      const firstDataCell = dataRows.at(0).findAll('.vertical-align-middle').at(1)
      const secondDataCell = dataRows.at(1).findAll('.vertical-align-middle').at(1)
