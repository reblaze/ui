        ...
        <div class="columns">
          ...
          <div class="column">
            <div class="field is-grouped is-pulled-right">
              <p class="control">
                <button
                  class="button is-small new-mobile-sdks-document-button"
          ...
          <table class="table is-narrow">
            <thead>
              <tr>
                ...
                <th class="is-size-7 width-500px">
                  Hash
                </th>
                <th class="is-size-7 width-60px has-text-centered pr-2">
                  Active
                </th>
            ...
            <tbody>
              <tr
                v-for="(signature, index) in selectedMobileSDK.signatures"
                :key="index"
              >
                <td
                  class="is-size-7 width-300px"
                  :title="signature.name"
                >
                  {{ signature.name }}
                </td>
                <td
                  class="is-size-7 width-500px"
      ...
      <div class="field">
        ...
        <div class="control">
          <table class="table is-narrow">
            ...
            <tbody v-else>
              <tr
                v-for="(config, index) in selectedMobileSDK.active_config"
                :key="index"
                :class="{'has-background-light': configAdditionalInfoIndex === index}"
                @click="setConfigAdditionalInfoIndex(index)"
              >
                <td
                  class="is-size-7 width-300px has-row-clickable"
                  :title="config.name"
                >
                ...
                <td class="is-size-7 width-500px has-row-clickable">
                  <textarea
                    v-if="configAdditionalInfoIndex === index"
                    rows="7"
