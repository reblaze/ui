          ...
          <div class="columns columns-divided">
            <div class="column is-4">
              ...
              <div class="field">
                ...
                <div class="control">
                  <input
                    class="input is-small document-masking-seed"
                    title="Masking seed"
                    data-qa="waf-masking"
              ...
              <div
                class="field ignore-alphanumeric-input-field"
            ...
            <div class="column is-4">
              <div class="field">
                ...
                <div class="control">
                  <div
                    v-for="decodingOption in decodingOptions"
      ...
      <div class="card-content px-0 py-0">
        ...
        <div class="content collapsible-content px-5 py-5">
          <div class="tag-lists-wrapper">
            <div class="columns mb-0">
              ...
              >
                ...
                <table class="table is-narrow is-fullwidth">
                  <tbody>
                    <tr
                      v-for="(tag, idx) in localDoc[section]"
                      :key="idx"
                    >
                      <td
            ...
            <div>
              <p
                class="has-text-danger is-size-7 tags-invalid"
                v-if="tagsInvalid"
              >
            ...
            >
              <div class="columns section-inputs-wrapper">
                <div class="column is-4">
                  <div class="field">
                    ...
                    <div class="control">
                      <input
                        class="input is-small section-max-length"
                        type="number"
                  ...
                  <div class="field">
                    ...
                    <div class="control">
                      <input
                        class="input is-small section-max-count"
                        type="number"
              ...
              <div class="section-constraints-wrapper my-5">
                ...
                >
                  <thead>
                    <tr>
                      <th class="has-text-centered width-30pct">
                        Parameter
                      </th>
                      <th class="has-text-centered width-25pct">
                        Matching Value
                      </th>
                      ...
                      <th class="has-text-centered width-5pct">
                        <a
                          v-show="newContentFilterLine !== currentSection"
                  ...
                  <tbody>
                    <tr
                      v-if="newContentFilterLine === currentSection"
                    ...
                    <tr
                      v-for="(entry, idx) in localDoc[currentSection].names"
                      class="entry-row"
                    ...
                    <tr
                      v-for="(entry, idx) in localDoc[currentSection].regex"
                      class="entry-row"
